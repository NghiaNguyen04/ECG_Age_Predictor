...
def main():
    ...
    rri_path = os.path.join(args.output_dir, "rri_full.csv")
    hrv_path = os.path.join(args.output_dir, "hrv_full.csv")
    rri_hrv_path = os.path.join(args.output_dir, "rri_hrv_full.csv")
